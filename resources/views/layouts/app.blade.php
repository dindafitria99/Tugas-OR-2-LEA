...
<head>
  ...
  <link rel="icon" href="{{ url('/assets/img/siswa.png') }}" type="image/x-icon"/>
  <style type="text/css">
    .dataTable td{
...
<body class="hold-transition skin-white fixed sidebar-mini">
<div class="wrapper">
  <?php
  ...
  <header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo">
      ...
      <span class="logo-mini"><b>Ex</b>Lea</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Exam</b>Lea</span>
    </a>
        ...
        <ul class="nav navbar-nav">
                  ...
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        ...
                        @else
                          <img src="{{ url('/assets/dist/img/08f7fbe4-4d38-4e0f-9637-feec16382e8e.png') }}" class="img-circle" alt="User Image">
                        @endif
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              @else
                <img src="{{ url('/assets/dist/img/08f7fbe4-4d38-4e0f-9637-feec16382e8e.png') }}" class="user-image" alt="User Image">
              @endif
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  {{ Auth::user()->nama }} 
                  <small class ="text-warning" >Member since 2020 </small>
                </p>
              </li>
              <!-- Menu Body -->
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview {{ Request::is('elearning*') == true  ? 'active' : '' }}">
          <a href="#">
            <i class="fa fa-graduation-cap"></i> <span>Examination</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            ...
            <li class="{{Request::is('elearning/laporan*') == true  ? 'active' : '' }}"><a href="{{ url('/elearning/laporan') }}"><i class="fa fa-circle-o"></i> Laporan/Hasil</a></li>
          </ul>
        </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Kelompok 5 Lea. {{ date('Y') }}</strong> <i>ExamLea </i>
  </footer>
</div>
<!-- ./wrapper -->
